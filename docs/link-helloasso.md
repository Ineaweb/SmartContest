...
2. Connectez-vous à votre compte SmartContest.
      ...
      ![Connexion SmartContest](img/link-helloasso/1.png)

3. Allez dans "Mon Profil".

      ![Mon Profil](img/link-helloasso/2.png)

4. Recherchez la section "HelloAsso".

      ![Section HelloAsso](img/link-helloasso/3.png)

5. Cliquez sur "Connecter à HelloAsso".

      ![Connecter HelloAsso](img/link-helloasso/4.png)
