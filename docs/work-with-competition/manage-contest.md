...
3. Sélectionnez le nouveau terrain dans la liste déroulante.
    ...
    ![Sélectionner terrain](../img/work-with-competition/manage-contest/10.png)
...
2. Cliquez sur le bouton "Ajouter un match".
    ...
    ![Ajouter match](../img/work-with-competition/manage-contest/13.png)

3. Sélectionnez les 2 équipes participantes.

    ![Sélectionner équipes](../img/work-with-competition/manage-contest/14.png)
