...
1. Accédez à la section **Equipes inscrites** dans le menu de gestion de votre compétition.
   ...
   ![Section Equipes inscrites](../img/work-with-competition/manage-participant/1.png)

2. Pour gérer les pré-inscriptions, cliquez sur **Gérer les pré-inscriptions**.

   ![Gérer les pré-inscriptions](../img/work-with-competition/manage-participant/2.png)
...
3. Vous pouvez voir la liste des pré-inscriptions avec les informations suivantes :
    ...
    ![Liste des pré-inscriptions](../img/work-with-competition/manage-participant/3.png)

### Ajouter manuellement une pré-inscription

1. Cliquez sur le bouton **Ajouter une pré-inscription**.

   ![Ajouter une pré-inscription](../img/work-with-competition/manage-participant/4.png)

2. Remplissez les informations requises dans le formulaire qui s'affiche.

    ![Formulaire pré-inscription](../img/work-with-competition/manage-participant/5.png)

3. Pour ajouter des membres à l'équipe, cliquez sur **Ajouter un membre** et remplissez les informations nécessaires.

   ![Ajouter membre](../img/work-with-competition/manage-participant/6.png)
...
2. Pour modifier une pré-inscription, cliquez sur ![icône édition](../img/work-with-competition/manage-participant/9.png). Apportez les modifications nécessaires dans le formulaire et cliquez sur **Enregistrer**.

3. Pour supprimer une pré-inscription, cliquez sur ![icône suppression](../img/work-with-competition/manage-participant/8.png).
...
1. Utilisez le champ de recherche en haut à droite pour trouver rapidement une pré-inscription spécifique en saisissant le nom de l'équipe ou d'un membre.
   ...
   ![Champ de recherche](../img/work-with-competition/manage-participant/10.png)
...
1. Cliquez sur le bouton **Importer depuis HelloAsso**.
   ...
   ![Importer depuis HelloAsso](../img/work-with-competition/manage-participant/11.png)

2. Mappez les champs de votre billetterie HelloAsso avec les champs de pré-inscription de la plateforme.

    ![Mapper champs](../img/work-with-competition/manage-participant/12.png)
...
4. Une fois l'importation terminée, les pré-inscriptions apparaissent dans la liste des pré-inscriptions avec comme origine "HelloAsso".
   ...
   ![Pré-inscriptions importées](../img/work-with-competition/manage-participant/14.png)
...
3. La pré-inscription est maintenant convertie en inscription et apparaît dans la liste des équipes inscrites.
   ...
   ![Inscription réussie](../img/work-with-competition/manage-participant/18.png)
...
1. Cliquez sur le bouton **Ajouter une équipe**.
   ...
   ![Ajouter une équipe](../img/work-with-competition/manage-participant/19.png)
...
1. Dans la liste des équipes inscrites, localisez celle que vous souhaitez modifier ou supprimer.
   ...
   ![Liste des équipes inscrites](../img/work-with-competition/manage-participant/22.png)

2. Pour modifier une inscription, cliquez sur ![icône édition](../img/work-with-competition/manage-participant/9.png). Apportez les modifications nécessaires dans le formulaire et cliquez sur **Enregistrer**.

3. Pour supprimer une inscription, cliquez sur ![icône suppression](../img/work-with-competition/manage-participant/8.png).
...
1. Saisissez le nom de l'équipe ou son numéro dans le champ de recherche en haut à droite.
   ...
   ![Champ de recherche](../img/work-with-competition/manage-participant/23.png)
...
2. Cliquez sur ![icône édition](../img/work-with-competition/manage-participant/9.png) pour modifier l'inscription.

3. Dans le formulaire de modification, cochez la case **Forfait** et cliquez sur **Enregistrer**.

    ![Modifier statut équipe](../img/work-with-competition/manage-participant/24.png)
...
2. Cliquez sur ![icône consultation](../img/work-with-competition/manage-participant/25.png) pour consulter les informations de l'équipe.

3. Une fenêtre contextuelle s'ouvre et affiche les informations de l'équipe.

   ![Informations d'inscription](../img/work-with-competition/manage-participant/26.png)