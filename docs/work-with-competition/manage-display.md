...
![Selection des classements à imprimer](../img/work-with-competition/manage-display/5.png)

Cliquez sur **Valider** pour générer le PDF des classements à imprimer.

![Classements](../img/work-with-competition/manage-display/6.png)
...
![Imprimer le classement général](../img/work-with-competition/manage-display/7.png)
...
![Selection de la phase à imprimer](../img/work-with-competition/manage-display/8.png)

Cliquez sur **Valider** pour générer le PDF du détail de la phase à imprimer.

![Détails](../img/work-with-competition/manage-display/9.png)

### Imprimer la liste des équipes

Pour imprimer la liste des équipes, cliquez sur le bouton **Imprimer la liste des équipes**.

![Liste des équipes](../img/work-with-competition/manage-display/10.png)
...
![Options d'impression des QR-codes](../img/work-with-competition/manage-display/11.png)
...
![QR-codes des équipes](../img/work-with-competition/manage-display/12.png)
...
![Section Affichage dynamique](../img/work-with-competition/manage-display/15.png)

Une deuxième fenêtre s'ouvrira automatiquement sur votre écran secondaire ou votre projecteur.

![Affichage secondaire](../img/work-with-competition/manage-display/16.png)
...
![Affichage des équipes enregistrées](../img/work-with-competition/manage-display/20.png)
...
![Affichage de l'organisation de la compétition](../img/work-with-competition/manage-display/21.png)
...
![Affichage des matchs en cours](../img/work-with-competition/manage-display/22.png)

### Afficher les classements

1. Cliquez sur le bouton **Afficher les classements** puis sélectionnez les classements que vous souhaitez afficher.

    ![selection des classements](../img/work-with-competition/manage-display/5.png)

2. Cliquez sur **Valider** pour afficher les classements sélectionnés.

    ![Affichage des classements](../img/work-with-competition/manage-display/23.png)

### Afficher les sponsors

1. Sélectionnez l'emplacement où se trouvent les visuels de vos sponsors en cliquant sur **Parcourir**.

    ![Selection du visuels des sponsors](../img/work-with-competition/manage-display/24.png)
