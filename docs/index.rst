...
===========================================
Documentation utilisateur de SmartContest
===========================================

Bienvenue dans la documentation utilisateur de SmartContest, la solution SaaS pour organiser vos compétitions sportives.
...
2. Saisissez le nom de la compétition (obligatoire).  
...
4. Sélectionnez **Démarrer la démo (1 heure)** ou **Démarrer ou programmer sur un jour (payant)**. Si vous avez sélectionné **Démarrer ou programmer sur un jour (payant)**, saisissez la date de début de votre compétition.
